    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="livicon icon3" data-name="users" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> <!-- About Us -->Partners
            </div>
        </div>
    </div>
    @stop
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="text-center">
                <h3 class="border-danger"><span class="heading_border bg-danger" >Our Partners</span></h3>
            </div>
            <!-- //Our Team Heading End -->
            <!-- Image1 Section Start -->
            <div class="col-md-4 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3.5s">
                <div class="thumbnail bg-white  text-center">
                    <img src="{{ asset('assets/images/partners/bmw-logo.png') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <!-- <b>John Doe</b>
                        <br /> Founder &amp; Partner
                        <br /> -->
            ...
            <div class="col-md-4 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="thumbnail bg-white text-center">
                    <img src="{{ asset('assets/images/partners/partner-logo.png') }}" alt="team-image">
                    <div class="caption">
            ...
            <div class="col-md-4 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="thumbnail bg-white  text-center">
                    <img src="{{ asset('assets/images/partners/partner-logo.png') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <!-- <b>Audrey Sheldon</b>
