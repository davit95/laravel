        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li {!! (Request::is('/') ? 'class="active"' : '') !!}><a href="{{ route('home') }}"> Manuscrits</a>
                    </li>
                    ...
                    @else
                        <li {{ (Request::is('my-account') ? 'class=active' : '') }}><a href="{{ URL::to('my-account') }}">Mon compte</a>
                        </li>
                        <li><a href="{{ URL::to('logout') }}">fermer la session</a>
                        </li>
                    @endif
                </ul>
            </div>
